...
const TEST_EMAIL = 'higartner@gmail.com';
...
(async () => {
  ...
  // Click input area and type email
  ...
  console.log(bodyText.includes(TEST_EMAIL) ? `✓ ${TEST_EMAIL} added as test user!` : '✗ Not found - check manually');
  await browser.close();
